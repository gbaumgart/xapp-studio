<div class="home" id="main-content" role="main">
		...
		<div class="portlet-layout">
			<div id="column-1" class="portlet-column portlet-column-only aui-w100 header-column-small">
				$processor.processColumn("column-1", "portlet-column-content portlet-column-content-only")
			</div>
		</div>
        ...
        <div class="portlet-layout mainStage">
            <div class="mainStageInner">
                <div id="column-2" class="portlet-column portlet-column-first aui-100 main-column">
                    $processor.processColumn("column-2", "portlet-column-content portlet-column-content-only")
                </div>
            </div>
        </div>

        <div class="portlet-layout mainStage2">
            <div class="mainStageInner">
                <div id="column-3" class="portlet-column portlet-column-first aui-100 main-column">
        ...
        <div class="portlet-layout mainStage2">
            <div class="mainStageInner">
                <div id="column-4" class="portlet-column portlet-column-first aui-100 main-column">
        ...
        <div class="portlet-layout mainStage2">
            <div class="mainStageInner">
                <div id="column-5" class="portlet-column portlet-column-first aui-100 main-column">
        ...
        <div class="portlet-layout mainStage2">
            <div class="mainStageInner">
                <div id="column-6" class="portlet-column portlet-column-first aui-100 main-column">
		...
		<div class="portlet-layout footer-main">
			<div id="column-7" class="portlet-column portlet-column-first aui-w100 bottom-column">
