<div class="home" id="main-content" role="main">
		...
		<div class="portlet-layout">
			<div id="column-1" class="portlet-column portlet-column-only aui-w100 qxapp-header-column">
				$processor.processColumn("column-1", "portlet-column-content portlet-column-content-only")
			</div>
		</div>

		<div class="portlet-layout qxappStage">
            <div class="qxappStageInner">
                <div id="column-2" class="portlet-column aui-w100 qxapp-column">
		...
		<div class="portlet-layout">
			<div id="column-3" class="portlet-column aui-w100 qxapp-bottom-column">
				$processor.processColumn("column-3", "portlet-column-content")
			</div>
		</div>
	#end
