...
<%@ include file="jspIncludes/xappshowFrameworkPaths.jsp" %>
...
%>
        <html>
	        ...
	        <jsp:include page="jspIncludes/XAPP_SHOW_JS_Includes.jsp"/>
	        <jsp:include page="jspIncludes/XAPP_SHOW_CSS_Includes.jsp"/>
	         <script>
	        ...
	        var returnUrl= "<%=url%>";
	        var showcaseId = "Home";
	        var forceLanguage2="en";
	        var forceLanguage="en";
	        
	        </script>
	        </head>
        <jsp:include page="jspIncludes/main/xappshowBodyTemplate.jsp"/>
        </html>
