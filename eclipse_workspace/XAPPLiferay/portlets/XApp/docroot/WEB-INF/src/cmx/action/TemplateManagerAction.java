...
public class TemplateManagerAction extends CMBaseAction
{
	/**
	 * 
	 */
	...
	@SMDMethod
	public CList getIconSet(String uuid,String appId,String identifier)
	{
		return TemplateManager.getIconSet(uuid,appId,identifier);
	}
	
	@SMDMethod
	public CList getAssetSet(String uuid,String appId,String identifier)
	{
		return TemplateManager.getAsset(uuid,appId,identifier);
	}
	...
	@SMDMethod
	public ArrayList<TemplateInfo>getTemplates(String uuid,
			String appIdentfier,
			String platform)
	{
		ArrayList<TemplateInfo>templates = TemplateManager.getTemplates(uuid, appIdentfier, platform);
