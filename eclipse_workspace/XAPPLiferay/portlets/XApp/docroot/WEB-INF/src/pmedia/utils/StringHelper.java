...
public class StringHelper 
{
	...
	public static ArrayList<String> split2(String s, String delimiter,int minLength,String blackList)
	{
		ArrayList<String> result = new ArrayList<String>();
		String terms[] = split(s,delimiter);
		
		if(terms !=null)
		{
			for(int tc = 0 ; tc < terms.length ; tc++ )
    		{
    			String term = terms[tc];
    			if(term.length() > minLength && !blackList.contains(term.toLowerCase()))
    			{
    				result.add(term);
    			}
    		}
