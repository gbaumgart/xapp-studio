...
%>
<script type="text/javascript" src="lib/external/easyXDM.debug.js"></script>
<script type="text/javascript" src="lib/external/jshashtable.min.js"></script>
<script type="text/javascript" src="lib/external/cssParser.min.js"></script>
<script type="text/javascript" src="lib/external/klass.min.js"></script>
<script type="text/javascript" src="lib/external/code.photoswipe-3.0.4.min.js"></script>
<script type="text/javascript" src="lib/external/qr/qrcode.js"></script>
