<%
    ...
    <% if(debugCSS){%>
	    <link rel="stylesheet" type="text/css" href="<%=_basePath %>themes/claro/document.css"/>
	    <link rel="stylesheet" type="text/css" href="<%=_basePath %>themes/claro/claro.css">
	    <link rel="stylesheet" href="<%=_basePath %>cssCommon/video-js.css" type="text/css" media="screen" title="Video JS">
	    <link href="<%=_basePath %>cssCommon/photoswipe.css" type="text/css" rel="stylesheet"/>
	    <link href="<%=_basePath %>cssCommon/styles.css" type="text/css" rel="stylesheet"/>
	    <link href="<%=_basePath %>cssCommon/qSheetStyles.css" type="text/css" rel="stylesheet"/>
	    <link href="<%=_basePath %>lib/cssCommon/forms.css" type="text/css" rel="stylesheet"/>
    <%}else{%>
	...
	<link rel="stylesheet" type="text/css" href="<%=_basePath %>css/xasCommons.css">
    <link rel="stylesheet" type="text/css" href="<%=_basePath %>css/QXWidgets.css">
    <link rel="stylesheet" type="text/css" href="<%=_basePath %>css/QXAppStudio.css">
    <link rel="stylesheet" type="text/css" href="<%=_basePath %>css/dijitOverride.css">
    
    
    
    <link rel="stylesheet" href="<%=_basePath %>lib/dojox/widget/Wizard/Wizard.css">
    <link rel="stylesheet" href="<%=_basePath %>lib/dojox/editor/plugins/resources/css/TextColor.css">
    
    <link rel="stylesheet" href="<%=_basePath %>css/set_complete_dnd.css">
    <link rel="stylesheet" type="text/css" href="<%=_basePath %>css/Fonts.css">
     <link rel="stylesheet" type="text/css" href="<%=_basePath %>xasCSSMobile/themes/iphone/gallery.css"></link>
