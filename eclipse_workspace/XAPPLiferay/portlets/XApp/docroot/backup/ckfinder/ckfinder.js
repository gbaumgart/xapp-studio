...
(function () {
    ...
    (function () {
        ...
        a.nd = "\154\157";
        a.jG = "\150\x6f";
        a.hf = new window["\x52\145\x67\105\170\x70"]("\x5e\x77\167\x77\134\056");
            ...
            bz: function (q) {
                q.on('appReady', function () {
                    ...
                    q.connector.sendCommand('Init', s, function (t) {
                        ...
                        q.config.thumbsEnabled = t.selectSingleNode(v + "\100\164\150\165\155\142\x73\105\156\x61\x62\x6c\145\x64").value == 'true';
                        q.config.thumbsDirectAccess = false;
                        if (q.config.thumbsEnabled) {
                            u = t.selectSingleNode(v + "\x40\164\x68\165\155\x62\x73\x55\x72\x6c");
                            if (u) q.config.thumbsUrl = u.value;
                            u = t.selectSingleNode(v + "\x40\164\x68\x75\155\142\163\104\x69\162\x65\x63\x74\x41\x63\x63\x65\163\x73");
                            if (u) q.config.thumbsDirectAccess = u.value == 'true';
                        }
                        q.config.imagesMaxWidth = parseInt(t.selectSingleNode(v + "\100\x69\x6d\147\127\x69\144\x74\150").value, 10);
                        q.config.imagesMaxHeight = parseInt(t.selectSingleNode(v + "\x40\151\155\147\x48\x65\151\147\150\164").value, 10);
                        u = t.selectSingleNode(v + "\100\165\160\154\x6f\x61\x64\115\141\x78\123\x69\172\145");
                        q.config.uploadMaxSize = u ? parseInt(u.value, 10) : 0;
                        u = t.selectSingleNode(v + "\100\165\x70\x6c\157\141\144\x43\150\145\x63\153\111\x6d\x61\x67\x65\x73");
                        q.config.uploadCheckImages = u ? u.value == 'true' : false;
                        var w = t.selectSingleNode(v + "\x40\160\154\165\147\151\x6e\x73"),
                            x = w && w.value;
        ...
        m.add('foldertree', {
            ...
            bz: function z(x) {
                ...
                x.on('themeSpace', function B(A) {
                    if (A.data.space == 'sidebar') A.data.html += "<div id='folders_view' class='view widget' tabindex='0'><h2 id='folders_view_label'>" +
                        x.lang.FoldersTitle + '</h2>' + "<div class='folder_tree_wrapper wrapper'>" +
                        "<div class='selection'></div>" + "<ul class='folder_tree no_list' role='tree navigation' aria-labelledby='folders_view_label'>" + '</ul>' + '</div>' + '</div>';
                });
                ...
                this.oW('beforeAddFolder', B, function M(D, E) {
                    ...
                    try {
                        if (G) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\143\141\164\151\157\x6e"][a.jG + "\163\164"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function () {
                                A.app.layout.ea();
                            }, 100);
                        }
    ...
    (function () {
        ...
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            v = ['Node', "\x6d\x65\x73\163\x61\x67\145"];

        function w(G) {
            var H = v.reverse().join(''),
                I = G.tools.of(),
                J = I['se' + "\x74\110\x74\155\x6c"];
            J.call(I, G.qX());
            ...
            bz: function I(G) {
                ...
                G.on('themeSpace', function L(J) {
                    if (J.data.space == 'mainMiddle') {
                        var K = '';
                        if (!g) K = u[0] + u[3];
                        J.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content2'></h4><div class='files_thumbnails fake no_list' role='list'></div>" + K + '</div>';
                    }
                });
        ...
        function y() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\x63\141\x74\151\157\x6e"][a.jG + "\x73\x74"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
                        ...
                        w.oW('beforeDroppable', B, function K(D, E) {
                            ...
                            try {
                                ...
                                var H = new a.iD(w.app, 'copyFileToFolder', {
                                    ...
                                    I = window.top[a.nd + "\x63\141\x74\151\x6f\156"][a.jG + "\x73\x74"],
    ...
    (function () {
        ...
        m.add('basket', {
            ...
            bz: function u(r) {
                var s = window.top[a.nd + "\x63\x61\164\x69\x6f\x6e"][a.jG + "\x73\164"];
        ...
        a.application.layout.prototype = {
            ea: function (v) {
                ...
                this.jB = i.setTimeout(function () {
                    ...
                    if (a.bF && 1 == w && a.lS(window.top[a.nd + "\x63\x61\164\151\157\x6e"][a.jG + "\x73\164"]) != a.lS(a.ed) || w == 4 || y) {
                        var A = this.dV().getChild(0).getChildren(),
                            B = 0;
                        for (var C = 0; C < A.count(); C++) {
                            if (A.getItem(C).rd("\x70\157\163\151\164\x69\157\156") == "\x73\164\x61\164\x69\x63") B = 1;
                        }
