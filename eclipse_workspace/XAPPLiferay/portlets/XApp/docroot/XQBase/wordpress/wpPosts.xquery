...
<articles v="3">
	...
	return 
	<art owner="{$net.bican.wordpress.Page/wp__author__id}" created="{$net.bican.wordpress.Page/dateCreated}" id="{$net.bican.wordpress.Page/postid}">
		<title>
			{
