<Locations v="3">
	{
	for $t_localidad in collection("t_localidad")/t_localidad 
	return 
	<region ln="{$t_localidad/lon}" lat="{$t_localidad/lat}" t="{$t_localidad/nom}" id="{$t_localidad/id}"/>
	}
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" useresolver="yes" url="" outputurl="" processortype="datadirect" tcpport="29471536" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
			...
			<collection name="mysql_localhost_3306" url="jdbc:xquery:mysql://localhost:3306;table=t_localidad;user=root;password=42622D3D44725F;xmlforest=true;DatabaseName=site;urltype=.xml"/>
	...
	<MapperMetaTag>
		...
		<MapperBlockPosition>
			<template name="xquery_body">
				<block path="Locations/flwr" x="122" y="41"/>
			</template>
		</MapperBlockPosition>
