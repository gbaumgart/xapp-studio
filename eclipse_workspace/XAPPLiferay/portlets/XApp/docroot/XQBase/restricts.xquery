<ezones v="3">
	{
	for $t_zona in collection("t_municipio")/t_municipio
	return 
	<ezone l="" t="{$t_zona/nom}" id="{$t_zona/id}"/>
	}
</ezones>(: Stylus Studio meta-information - (c) 2004-2009. Progress Software Corporation. All rights reserved.
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" useresolver="yes" url="" outputurl="" processortype="datadirect" tcpport="29471536" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
			...
			<collection name="mysql_localhost_3306" url="jdbc:xquery:mysql://localhost:3306;table=t_municipio;user=root;password=42622D3D44725F;xmlforest=true;DatabaseName=site;urltype=.xml"/>
	...
	<MapperMetaTag>
		...
		<MapperBlockPosition>
			<template name="xquery_body">
				<block path="ezones/flwr" x="168" y="144"/>
			</template>
		</MapperBlockPosition>
