<topics v="3">
	{
	for $t_tema in collection("t_tema")/t_tema 
	return 
	<topic t="{$t_tema/nom}" id="{$t_tema/id}"/>
	}
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" useresolver="yes" url="" outputurl="" processortype="datadirect" tcpport="29471536" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
			...
			<collection name="mysql_localhost_3306" url="jdbc:xquery:mysql://localhost:3306;table=t_tema;user=root;password=42622D3D44725F;xmlforest=true;DatabaseName=site;urltype=.xml"/>
	...
	<MapperMetaTag>
		...
		<MapperBlockPosition>
			<template name="xquery_body">
				<block path="topics/flwr" x="74" y="133"/>
			</template>
		</MapperBlockPosition>
