...
declare option  ddtek:serialize "cdata-section-elements=description";
<Results>
	{
	for $jos_categories in collection("prefixxcategories")/prefixxcategories
	return
	<item pub="{$jos_categories/published}" level="{$jos_categories/level}">
		<id>
			{
