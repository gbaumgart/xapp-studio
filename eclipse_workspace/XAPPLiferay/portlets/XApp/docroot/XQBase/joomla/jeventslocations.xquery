...
<articles v="3">
	...
	return 
	<art created="{$net.bican.wordpress.JoomlaXMLData/created}" id="{$net.bican.wordpress.JoomlaXMLData/refId}" cid="{$net.bican.wordpress.JoomlaXMLData/groupId}" ac="{$net.bican.wordpress.JoomlaXMLData/access}" owner="{$net.bican.wordpress.JoomlaXMLData/created__by}" ownerName="{$net.bican.wordpress.JoomlaXMLData/created__by__name}"
