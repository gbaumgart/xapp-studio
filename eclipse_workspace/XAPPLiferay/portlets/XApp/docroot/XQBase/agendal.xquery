...
declare option  ddtek:serialize "cdata-section-elements=descr;subt";
<articles v="3">
	{
	...
	where (((string($b/tipo) = string("2")) and (string($b/fini) != string("0000-00-00"))) and (year-from-date($b/fini) >= 2011) and string($articulo_lan/lang) = string($lang) )
	return 
