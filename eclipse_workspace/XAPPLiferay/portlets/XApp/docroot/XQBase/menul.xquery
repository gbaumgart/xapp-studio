<emenues v="3">
	{
	for $t_menu_lan in collection("t_menu_lan")/t_menu_lan 
	return 
	<eMenu l="{$t_menu_lan/lang}" t="{$t_menu_lan/nom}" id="{$t_menu_lan/id}" type="menu"/>
	}
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" useresolver="yes" url="" outputurl="" processortype="datadirect" tcpport="29471536" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
			...
			<collection name="mysql_localhost_3306" url="jdbc:xquery:mysql://localhost:3306;table=t_menu_lan;user=root;password=42622D3D44725F;xmlforest=true;DatabaseName=site;urltype=.xml"/>
	...
	<MapperMetaTag>
		...
		<MapperBlockPosition>
			<template name="xquery_body">
				<block path="emenues/flwr" x="89" y="64"/>
			</template>
		</MapperBlockPosition>
